...
object UppaalConverter {
  ...
  def convert(inputText: String): String = {
    ...
    // CORREÇÃO 1: Usar string de três aspas para a regex
...
system Process;"""
    ...
    // CORREÇÃO 2 e 3: Usar o PrettyPrinter padrão e depois substituir os espaços por tabs
    ...
    val xmlHeader = """<?xml version="1.0" ?>""" // Ajustado para ser idêntico ao do Python
